...
<html>
  <head>
    ...
    <script type="text/javascript">
        function addCustomerInfo(){
              var formMap = DWRUtil.getValues("addCustomerInfoForm");//<form name="addCustomerInfoForm"
              AddCustomerInfoAjax.saveCustomerInfo(formMap,result);
  ...
  <body> 
		 <h1 align="center" style="font-family:华义彩云;"> 客户信息添加</h1>
			<form name="addCustomerInfoForm"   action="addCustomerInfo.action" method="post" target="main">
				    ...
				    <tr style="padding:5px;">
					  ...
					  <tr style="padding:5px;">
				        ...
				        <tr style="padding:5px;">
					      ...
					      <td>
					      <input type="text" name="register"  value="深深深" readonly="readonly">
			      ...
			      <p align="center">
			      <input type="button" value="提交" onclick="addCustomerInfo();">
