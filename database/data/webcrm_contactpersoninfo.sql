...
--
-- Table structure for table `contactpersoninfo`
--

DROP TABLE IF EXISTS `contactpersoninfo`;
...
--
-- Dumping data for table `contactpersoninfo`
--

LOCK TABLES `contactpersoninfo` WRITE;
/*!40000 ALTER TABLE `contactpersoninfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `contactpersoninfo` ENABLE KEYS */;
UNLOCK TABLES;
